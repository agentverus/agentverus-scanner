import type { BadgeTier, Category, CategoryScore, Finding } from "./types.js";
...
export function determineBadge(score: number, findings: readonly Finding[]): BadgeTier {
...
export function calculateOverallScore(categories: Record<Category, CategoryScore>): number {
