...
- **Release automation follow-up**: a broader `release:prepare` flow could scaffold scanner/web version bumps and changelog/link updates together, but only if it preserves human-authored release notes instead of overwriting them.
